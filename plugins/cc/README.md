> archive compatibility notice: `cc` is frozen and supported only for security, data-loss, and installation blockers through 2026-11-05. see [archived tools](../../content/archive/claude-code-tools.md).
