...
**note (v2.1.205+)**: these compaction percentages reflect historical data from v2.1.122. compaction behavior and rates may have improved in current versions. run `/lore` to see actual compaction rates for your sessions and compare against this baseline.
