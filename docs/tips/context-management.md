...
**note (v2.1.206)**: compaction rates and behavior may have improved since v2.1.122. the 32%/54% percentages reflect historical data. run `/lore` on your current version to see actual compaction rates for your sessions and compare against this baseline.
