...
**verification note (v2.1.205+)**: these percentages are historical baseline data from v2.1.122. compaction behavior may have improved in recent versions. run `/lore compaction` on your current version to see actual compaction rates for your sessions and compare against this baseline.
