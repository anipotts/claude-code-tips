...
**v2.1.176 note:** monitor support on bedrock, vertex AI, and microsoft foundry remains unconfirmed. use `/doctor` to check platform compatibility for your deployment.
