...
⚠️ **historical baseline**: these numbers reflect v2.1.122 session data (april 2026). compaction behavior and context efficiency have likely improved in v2.1.204+. run `/lore` to check your actual session metrics and compare against this baseline.
