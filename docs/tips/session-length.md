...
**note (v2.1.207):** compaction rates and session efficiency metrics may have improved since v2.1.122 baseline. the percentages above reflect historical data. run `/lore` on your current version to see actual compaction rates and compare against this baseline.
