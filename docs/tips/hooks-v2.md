...
this also applies to organization default models (v2.1.196+). hooks inherit org/role model restrictions. if your hook needs a specific model, verify it's in the allowlist before relying on it.
