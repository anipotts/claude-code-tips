...
**note (v2.1.179+)**: verify current hook behavior and enforceAvailableModels interaction via `/doctor`. settings schema evolution may affect hook parameter handling.
