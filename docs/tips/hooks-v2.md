...
**verification note (v2.1.172+)**: hook types, fields, and behavior may have evolved. run `/doctor` or check official code.claude.com/docs for current hook capabilities before implementing custom hooks.
