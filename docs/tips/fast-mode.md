...
## tracking actual cost (v2.1.149+)

run `/usage` to see a per-category breakdown of what's driving your limits. the output now shows cost attribution by skills, subagents, plugins, and MCP servers. this makes it easier to spot whether fast mode's throughput gains actually offset the reasoning-skip cost in your actual workflows.
