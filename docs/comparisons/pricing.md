...
<!-- updated 2026-04-28 -->
openai codex continues alpha releases (0.126.0-alpha.7-9) but no stable version bumps. gemini-cli active development with context manager, error handling, and security fixes. no pricing changes detected across codex, gemini, or antigravity. claude code remains the dominant terminal agent for cost-conscious teams.
