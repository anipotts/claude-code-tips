...
**note: tool versions and pricing verified as of may 26 2026 (claude code v2.1.140+, current v2.1.168). these tools and their pricing change frequently. verify current status before recommending to users.**
