...
note: upstream tool versions and pricing verified as of april 9 2026. claude code releases v2.1.119 have shipped since verification. skill collection workflows and development workflow benchmarking have been added to upstream tracking. check individual comparison docs for staleness flags.
