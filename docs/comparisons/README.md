...
note: upstream tool versions and pricing verified as of april 2026. claude code releases v2.1.116 through v2.1.128 have shipped since verification. **v2.1.128 includes breaking changes to worktree behavior and MCP reconnection handling.** check individual comparison docs for staleness flags.
