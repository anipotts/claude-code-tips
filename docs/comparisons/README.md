...
**note: tool versions and pricing verified as of june 1 2026 (claude code v2.1.159+). these tools and their pricing change frequently. verify current status before recommending to users.**
