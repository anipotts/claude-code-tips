...
**note: tool versions and pricing verified as of may 19 2026 (claude code v2.1.144). these tools and their pricing change frequently. verify current status before recommending to users.**
