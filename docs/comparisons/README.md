...
note: upstream tool versions and pricing verified as of april 2026. claude code has released through v2.1.138 (may 2026). check individual comparison docs for staleness flags.
