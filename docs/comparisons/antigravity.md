...
antigravity's public preview status and pricing as of may 2026 are unconfirmed. **verify current pricing and availability at [antigravity.google/pricing](https://antigravity.google/pricing) before recommending to users.** google has not announced permanent post-preview pricing or whether free tier access continues.
