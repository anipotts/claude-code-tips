...
**status (june 2026)**: antigravity's public preview status and pricing remain unconfirmed. last detailed verification was april 9 2026. before recommending to users, check [antigravity.google/pricing](https://antigravity.google/pricing) directly. this doc's claims are stale and should not be cited for purchase decisions.
