...
> **always reference [anthropic pricing](https://docs.anthropic.com/en/docs/about-claude/models) for current rates.** last verified with claude code v2.1.150 (may 2026). pricing and model releases change frequently.
