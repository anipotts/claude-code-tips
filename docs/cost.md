...
> **always reference [anthropic pricing](https://docs.anthropic.com/en/docs/about-claude/models) for current rates.** last verified may 19 2026 (claude code v2.1.144). anthropic updates pricing regularly.
